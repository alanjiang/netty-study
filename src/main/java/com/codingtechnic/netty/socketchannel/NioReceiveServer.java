...
public class NioReceiveServer {
    ...
    private Charset chset = Charset.forName("UTF-8");
    ...
    public void startServer(String destPath) throws IOException {
        // 1、获取Selector选择器
     ...
     * 处理客户端传输过来的数据
     */
    private void processData(SelectionKey key, String destPath) throws IOException {
        ...
        try {
            ...
            while ((num = socketChannel.read(buffer)) > 0) {
                ...
                if (null == client.fileName) {
                    ...
                    // 文件名
                    String fileName = chset.decode(buffer).toString();
    ...
    public static void main(String[] args) throws Exception {
        ...
        String destPath = "/demo.sql";
        server.startServer(destPath);
    }
